...
export default function EleccionesChile2025() {
  ...
  const TimeCard = ({ value, label }) => (
    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 min-w-[100px] shadow-xl">
      <div className="text-4xl md:text-5xl font-bold text-white mb-1">
        {String(value).padStart(2, '0')}
      </div>
      <div className="text-sm text-blue-100 uppercase tracking-wide">{label}</div>
    </div>
  );
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-5xl w-full">
          ...
          <div className="mt-8 text-center">
            <div className="inline-block bg-white/10 backdrop-blur-md rounded-lg px-6 py-3 border border-white/20">
